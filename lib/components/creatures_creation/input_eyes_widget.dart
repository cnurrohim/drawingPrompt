...
class InputEyesWidget extends StatelessWidget {
  const InputEyesWidget({ Key? key }) : super(key: key);
  ...
  Widget _buildForm(context) {
    ...
    return Column(
      ...
      children: [
        const CustomHeadingWidget('eyes', 24.0, Colors.orange),
        const SizedBox(height: 10),
        CustomRadioWidget(
          featuresList:inputController.numberOfEyes,
          valueGroup: inputController.selectedEyesFeature,
          onChanged: (value){
              inputController.changeSelectedEyesFeatures(value);
          },
        )
      ],
    );
